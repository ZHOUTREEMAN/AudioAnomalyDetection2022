...
net = torch.load("./model/noise_{}_vae_auto_encoder_epoch40000_batch967.pth".format(feature))
...
plt.legend()
plt.savefig('./model/threshold_{}_vae.png'.format(feature))
np.save('./model/threshold_{}_vae.npy'.format(feature), threshold)
